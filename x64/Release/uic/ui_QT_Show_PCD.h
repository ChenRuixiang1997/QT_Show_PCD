...
public:
    ...
    void setupUi(QMainWindow *QT_Show_PCDClass)
    {
        ...
        QT_Show_PCDClass->resize(662, 367);
        ...
        qvtkWidget->setGeometry(QRect(30, 10, 521, 291));
        voxelGridButton = new QPushButton(centralWidget);
        voxelGridButton->setObjectName(QStringLiteral("voxelGridButton"));
        voxelGridButton->setEnabled(true);
        voxelGridButton->setGeometry(QRect(560, 30, 93, 28));
    ...
    void retranslateUi(QMainWindow *QT_Show_PCDClass)
    {
        ...
        voxelGridButton->setText(QApplication::translate("QT_Show_PCDClass", "\347\202\271\344\272\221\344\270\213\351\207\207\346\240\267", Q_NULLPTR));
