...
public:
    ...
    QPushButton *loadPointCloudAfterPlane;
    ...
    void setupUi(QMainWindow *QT_Show_PCDClass)
    {
        ...
        saveAsPCD->setGeometry(QRect(760, 10, 81, 21));
        ...
        groupBox_3->setGeometry(QRect(10, 240, 261, 231));
        layoutWidget8 = new QWidget(groupBox_3);
        layoutWidget8->setObjectName(QStringLiteral("layoutWidget8"));
        layoutWidget8->setGeometry(QRect(10, 30, 241, 23));
        horizontalLayout_24 = new QHBoxLayout(layoutWidget8);
        ...
        minRadius = new QLineEdit(layoutWidget8);
        ...
        layoutWidget9->setGeometry(QRect(10, 60, 241, 23));
        ...
        maxRadius = new QLineEdit(layoutWidget9);
        ...
        layoutWidget10->setGeometry(QRect(11, 90, 241, 135));
        verticalLayout_15 = new QVBoxLayout(layoutWidget10);
        verticalLayout_15->setSpacing(6);
        verticalLayout_15->setContentsMargins(11, 11, 11, 11);
        verticalLayout_15->setObjectName(QStringLiteral("verticalLayout_15"));
        verticalLayout_15->setContentsMargins(0, 0, 0, 0);
        loadPointCloudAfterPlane = new QPushButton(layoutWidget10);
        loadPointCloudAfterPlane->setObjectName(QStringLiteral("loadPointCloudAfterPlane"));

        verticalLayout_15->addWidget(loadPointCloudAfterPlane);

        showOriginalPointCloud2 = new QPushButton(layoutWidget10);
...
"\346\263\242", Q_NULLPTR));
        ...
        loadPointCloudAfterPlane->setText(QApplication::translate("QT_Show_PCDClass", "\350\275\275\345\205\245\345\271\263\351\235\242\345\210\206\345\211\262\345\220\216\347\202\271\344\272\221", Q_NULLPTR));
